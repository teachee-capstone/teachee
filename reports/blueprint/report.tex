...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{p{2in}|p{2in}|p{2in}}
        ...
        \hline
        Software Conversion Rate Problems

        & It is possible that the software can bottleneck the processing of ADC
        samples or be unable to achieve the framerates needed for the GUI.

        & If the group is unable to make performance gains in the software, the
        resolution will be to lower sampling rates until the software is able to
