...
it reports that the project is on schedule, showing progress in all
domains, that all supplies will be delivered on time, and that the budget will
be met. It identifies which members are responsible for each sections in the
upcoming tasks. There is an equal division of responsibility between group
members as shown in Table \ref{hw:milestones-table}.
