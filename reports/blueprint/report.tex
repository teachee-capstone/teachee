...
Given below is a breakdown of the team's project schedule and key milestones.
The main focus of the fall semester is hardware design and validation while the
software will be mostly written in the winter term.
% Table of major and intermediate milestones (ERIC)
% Each table cell should include due date and assigned member
\begin{table}[h!]
    \caption{TeachEE Project Milestones and Deliverables}
    \begin{tabularx}{\textwidth}{l|l|l|l}
        \textbf{No.} & \textbf{Milestone} & \textbf{Due Date} & \textbf{Responsible Member(s)} \\
        \hline
        1 & PCB Order Submission & Week 5 & Ethan \\
        2 & Blueprint Report Submission & Week 9 & Everyone \\
        3 & PCBs Received & Week 11 & Ethan \\
        4 & Finish Board Power-up Sequence and FPGA Integration & Week 13 & Ethan \\
        5 & Write HDL code to send data to the computer from the FPGA & Week 14 & Ethan / Timothy \\
        6 & Write HDL code to capture current sensor data. & Week 14 & Ethan \\
        7 & Write HDL code to capture voltage data on the FPGA's built in ADC. & Week 14 & Ethan \\
        8 & Complete FPGA Driver for the Discrete ADC & Week 15 & Ethan \\
    \end{tabularx} 
