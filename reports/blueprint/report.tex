...
This report clearly articulates the design decisions involved in development and
deployment. The blueprint provides certain requirements (cross platform,
reliable, etc.) and how the design is derived from these requirements. For
example, one requirement is high performance due to the desired sample rate for
the device. From this requirement, design decision can be justified, in this
case the choice of Tauri, since it utilizes Rust, a high performance systems
