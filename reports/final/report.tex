...
% Talk about ADC AXIS WRAPPERS AND HOW THEY BOTH FOLLOW THE SAME CONTROL FLOW

% Code snippets for the two ADC wrapper instances. Note that they are not
% actually in this order in the actual file
\setstretch{1}
\begin{minted}{systemverilog}
...
\subsubsection{AXIS and Verilog AXIS} \label{sec:external-fpga-libs}
% Cite the AXI Stream whitepaper from ARM
