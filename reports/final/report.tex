...
this new learning model. Much of the onsite equipment is ill-suited for online
learning due to its high cost and poor portability. Additionally, the take-home
equipment provided to students during the pandemic was typically of lower
quality in comparison. In particular, the oscilloscopes provided by the
Electronics II course taught at Queen's University were expensive and of poor
quality. They had tiny 3-inch displays and a small maximum bandwidth of 100 kHz.
Moreover, they were single channel, limiting the student's ability to see how
signals in a circuit are related to one another.
...
microprocessor. This was decided to ensure that there is no real-time data
processing limitations, and that there is precise timing in our sampling of the
signal waveforms. Moreover, an FPGA or ASCI is commonly used in existing
...
kits. Additionally, the implementation of certain features was poor; the display
was unable to simultaneously show the frequency and time domain, and it was
poorly indicated which was currently being dislpayed. 
