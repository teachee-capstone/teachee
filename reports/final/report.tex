...
advantage of Altium's hierarchical schematics. This allows the schematic to be
...
wired to this clock was swapped to a normal GPIO pin rather than an Multi Region
...
kits. Additionally, the scopes and signal generators had few protections against
extraneous inputs resulting in students accidentally breaking their tools when
incorrectly connected. At a functional level, the scopes were missing critical
features. They were single channel and had no ability to measure current or
