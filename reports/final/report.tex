...
interconnections between modules in the top-level SystemVerilog module. The code
for the top level module of TeachEE is given below. The entire RTL codebase can
be viewed in Appendix \ref{appendix:rtl-code}.
