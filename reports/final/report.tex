...
% TODO: but a figure of the received PCBs from Bittele here
...
% Then also add a figure of what the board looked like after the final assembly
% steps and population of the FPGA module
...
% NOTE From Ethan: This was done earlier in the report reference those tables.
% We met specs so reflect on that I guess.
